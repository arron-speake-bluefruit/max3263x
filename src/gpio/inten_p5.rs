#[doc = "Register `INTEN_P5` reader"]
pub struct R(crate::R<INTEN_P5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTEN_P5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTEN_P5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTEN_P5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INTEN_P5` writer"]
pub struct W(crate::W<INTEN_P5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INTEN_P5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INTEN_P5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INTEN_P5_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Field `pin0` writer - P5.0 External Interrupt Enable"]
pub struct PIN0_W<'a> {
    w: &'a mut W,
}
impl<'a> PIN0_W<'a> {
...
#[doc = "Field `pin1` writer - P5.1 External Interrupt Enable"]
pub struct PIN1_W<'a> {
    w: &'a mut W,
}
impl<'a> PIN1_W<'a> {
...
#[doc = "Field `pin2` writer - P5.2 External Interrupt Enable"]
pub struct PIN2_W<'a> {
    w: &'a mut W,
}
impl<'a> PIN2_W<'a> {
...
#[doc = "Field `pin3` writer - P5.3 External Interrupt Enable"]
pub struct PIN3_W<'a> {
    w: &'a mut W,
}
impl<'a> PIN3_W<'a> {
...
#[doc = "Field `pin4` writer - P5.4 External Interrupt Enable"]
pub struct PIN4_W<'a> {
    w: &'a mut W,
}
impl<'a> PIN4_W<'a> {
...
#[doc = "Field `pin5` writer - P5.5 External Interrupt Enable"]
pub struct PIN5_W<'a> {
    w: &'a mut W,
}
impl<'a> PIN5_W<'a> {
...
#[doc = "Field `pin6` writer - P5.6 External Interrupt Enable"]
pub struct PIN6_W<'a> {
    w: &'a mut W,
}
impl<'a> PIN6_W<'a> {
...
#[doc = "Field `pin7` writer - P5.7 External Interrupt Enable"]
pub struct PIN7_W<'a> {
    w: &'a mut W,
}
impl<'a> PIN7_W<'a> {
...
impl R {
    #[doc = "Bit 0 - P5.0 External Interrupt Enable"]
    #[inline(always)]
    pub fn pin0(&self) -> PIN0_R {
        PIN0_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - P5.1 External Interrupt Enable"]
    #[inline(always)]
    pub fn pin1(&self) -> PIN1_R {
        PIN1_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - P5.2 External Interrupt Enable"]
    #[inline(always)]
    pub fn pin2(&self) -> PIN2_R {
        PIN2_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - P5.3 External Interrupt Enable"]
    #[inline(always)]
    pub fn pin3(&self) -> PIN3_R {
        PIN3_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - P5.4 External Interrupt Enable"]
    #[inline(always)]
    pub fn pin4(&self) -> PIN4_R {
        PIN4_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - P5.5 External Interrupt Enable"]
    #[inline(always)]
    pub fn pin5(&self) -> PIN5_R {
        PIN5_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 6 - P5.6 External Interrupt Enable"]
    #[inline(always)]
    pub fn pin6(&self) -> PIN6_R {
        PIN6_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 7 - P5.7 External Interrupt Enable"]
    #[inline(always)]
...
#[doc = "Port P5 Interrupt Enables\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [inten_p5](index.html) module"]
pub struct INTEN_P5_SPEC;
impl crate::RegisterSpec for INTEN_P5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [inten_p5::R](R) reader structure"]
impl crate::Readable for INTEN_P5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [inten_p5::W](W) writer structure"]
impl crate::Writable for INTEN_P5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets INTEN_P5 to value 0"]
impl crate::Resettable for INTEN_P5_SPEC {
    #[inline(always)]
