#[doc = "Register `IN_VAL_P8` reader"]
pub struct R(crate::R<IN_VAL_P8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IN_VAL_P8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IN_VAL_P8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IN_VAL_P8_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IN_VAL_P8` writer"]
pub struct W(crate::W<IN_VAL_P8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IN_VAL_P8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IN_VAL_P8_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IN_VAL_P8_SPEC>) -> Self {
        W(writer)
    }
}
...
impl R {
    ...
    #[doc = "Bit 1 - P8.1 Input Value"]
    #[inline(always)]
    pub fn pin1(&self) -> PIN1_R {
        PIN1_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - P8.2 Input Value"]
    #[inline(always)]
    pub fn pin2(&self) -> PIN2_R {
        PIN2_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - P8.3 Input Value"]
    #[inline(always)]
    pub fn pin3(&self) -> PIN3_R {
        PIN3_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - P8.4 Input Value"]
    #[inline(always)]
    pub fn pin4(&self) -> PIN4_R {
        PIN4_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - P8.5 Input Value"]
    #[inline(always)]
    pub fn pin5(&self) -> PIN5_R {
        PIN5_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - P8.6 Input Value"]
    #[inline(always)]
    pub fn pin6(&self) -> PIN6_R {
        PIN6_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - P8.7 Input Value"]
    #[inline(always)]
...
#[doc = "Port P8 GPIO Input Value\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [in_val_p8](index.html) module"]
pub struct IN_VAL_P8_SPEC;
impl crate::RegisterSpec for IN_VAL_P8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [in_val_p8::R](R) reader structure"]
impl crate::Readable for IN_VAL_P8_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [in_val_p8::W](W) writer structure"]
impl crate::Writable for IN_VAL_P8_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets IN_VAL_P8 to value 0"]
impl crate::Resettable for IN_VAL_P8_SPEC {
    #[inline(always)]
