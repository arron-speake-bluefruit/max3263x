#[doc = "Register `FREE_P4` reader"]
pub struct R(crate::R<FREE_P4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FREE_P4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FREE_P4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FREE_P4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FREE_P4` writer"]
pub struct W(crate::W<FREE_P4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FREE_P4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FREE_P4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FREE_P4_SPEC>) -> Self {
        W(writer)
    }
}
...
impl R {
    #[doc = "Bit 0 - P4.0 GPIO Mode Acknowledge"]
    #[inline(always)]
    pub fn pin0(&self) -> PIN0_R {
        PIN0_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - P4.1 GPIO Mode Acknowledge"]
    #[inline(always)]
    pub fn pin1(&self) -> PIN1_R {
        PIN1_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - P4.2 GPIO Mode Acknowledge"]
    #[inline(always)]
    pub fn pin2(&self) -> PIN2_R {
        PIN2_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - P4.3 GPIO Mode Acknowledge"]
    #[inline(always)]
    pub fn pin3(&self) -> PIN3_R {
        PIN3_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - P4.4 GPIO Mode Acknowledge"]
    #[inline(always)]
    pub fn pin4(&self) -> PIN4_R {
        PIN4_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - P4.5 GPIO Mode Acknowledge"]
    #[inline(always)]
    pub fn pin5(&self) -> PIN5_R {
        PIN5_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - P4.6 GPIO Mode Acknowledge"]
    #[inline(always)]
    pub fn pin6(&self) -> PIN6_R {
        PIN6_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - P4.7 GPIO Mode Acknowledge"]
    #[inline(always)]
...
#[doc = "Port P4 Free for GPIO Operation Flags\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [free_p4](index.html) module"]
pub struct FREE_P4_SPEC;
impl crate::RegisterSpec for FREE_P4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [free_p4::R](R) reader structure"]
impl crate::Readable for FREE_P4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [free_p4::W](W) writer structure"]
impl crate::Writable for FREE_P4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FREE_P4 to value 0"]
impl crate::Resettable for FREE_P4_SPEC {
    #[inline(always)]
