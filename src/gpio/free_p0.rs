#[doc = "Register `FREE_P0` reader"]
pub struct R(crate::R<FREE_P0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FREE_P0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FREE_P0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FREE_P0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FREE_P0` writer"]
pub struct W(crate::W<FREE_P0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FREE_P0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FREE_P0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FREE_P0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `pin0` reader - P0.0 GPIO Mode Acknowledge"]
...
#[doc = "Field `pin1` reader - P0.1 GPIO Mode Acknowledge"]
...
#[doc = "Field `pin2` reader - P0.2 GPIO Mode Acknowledge"]
...
#[doc = "Field `pin3` reader - P0.3 GPIO Mode Acknowledge"]
...
#[doc = "Field `pin4` reader - P0.4 GPIO Mode Acknowledge"]
...
#[doc = "Field `pin5` reader - P0.5 GPIO Mode Acknowledge"]
...
#[doc = "Field `pin6` reader - P0.6 GPIO Mode Acknowledge"]
...
#[doc = "Field `pin7` reader - P0.7 GPIO Mode Acknowledge"]
...
#[doc = "Port P0 Free for GPIO Operation Flags\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [free_p0](index.html) module"]
pub struct FREE_P0_SPEC;
impl crate::RegisterSpec for FREE_P0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [free_p0::R](R) reader structure"]
impl crate::Readable for FREE_P0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [free_p0::W](W) writer structure"]
impl crate::Writable for FREE_P0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FREE_P0 to value 0"]
impl crate::Resettable for FREE_P0_SPEC {
    #[inline(always)]
