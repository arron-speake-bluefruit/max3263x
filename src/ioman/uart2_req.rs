#[doc = "Register `UART2_REQ` reader"]
pub struct R(crate::R<UART2_REQ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UART2_REQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UART2_REQ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UART2_REQ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UART2_REQ` writer"]
pub struct W(crate::W<UART2_REQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UART2_REQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UART2_REQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UART2_REQ_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "UART2 I/O Mode Request\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uart2_req](index.html) module"]
pub struct UART2_REQ_SPEC;
impl crate::RegisterSpec for UART2_REQ_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uart2_req::R](R) reader structure"]
impl crate::Readable for UART2_REQ_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uart2_req::W](W) writer structure"]
impl crate::Writable for UART2_REQ_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UART2_REQ to value 0"]
impl crate::Resettable for UART2_REQ_SPEC {
    #[inline(always)]
