#[doc = "Register `SPI1_REQ` reader"]
pub struct R(crate::R<SPI1_REQ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPI1_REQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPI1_REQ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPI1_REQ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPI1_REQ` writer"]
pub struct W(crate::W<SPI1_REQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI1_REQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI1_REQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI1_REQ_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `core_io_req` reader - SPI Master 1 Core I/O Request"]
...
#[doc = "Field `core_io_req` writer - SPI Master 1 Core I/O Request"]
...
#[doc = "Field `ss0_io_req` reader - SPI Master 1 SS\\[0\\]
I/O Request"]
...
#[doc = "Field `ss0_io_req` writer - SPI Master 1 SS\\[0\\]
I/O Request"]
...
#[doc = "Field `ss1_io_req` reader - SPI Master 1 SS\\[1\\]
I/O Request"]
...
#[doc = "Field `ss1_io_req` writer - SPI Master 1 SS\\[1\\]
I/O Request"]
...
#[doc = "Field `ss2_io_req` reader - SPI Master 1 SS\\[2\\]
I/O Request"]
...
#[doc = "Field `ss2_io_req` writer - SPI Master 1 SS\\[2\\]
I/O Request"]
...
#[doc = "Field `quad_io_req` reader - SPI Master 1 Quad I/O Request"]
...
#[doc = "Field `quad_io_req` writer - SPI Master 1 Quad I/O Request"]
...
#[doc = "Field `fast_mode` reader - SPI Master 1 Fast Mode Request"]
...
#[doc = "Field `fast_mode` writer - SPI Master 1 Fast Mode Request"]
...
pub struct SPI1_REQ_SPEC;
impl crate::RegisterSpec for SPI1_REQ_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi1_req::R](R) reader structure"]
impl crate::Readable for SPI1_REQ_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi1_req::W](W) writer structure"]
impl crate::Writable for SPI1_REQ_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPI1_REQ to value 0"]
impl crate::Resettable for SPI1_REQ_SPEC {
    #[inline(always)]
