...
pub struct ALI_ACK_P4_R(crate::FieldReader<u8, u8>);
impl ALI_ACK_P4_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        ALI_ACK_P4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ALI_ACK_P4_R {
...
pub struct ALI_ACK_P5_R(crate::FieldReader<u8, u8>);
impl ALI_ACK_P5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        ALI_ACK_P5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ALI_ACK_P5_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct ALI_ACK_P6_R(crate::FieldReader<bool, bool>);
impl ALI_ACK_P6_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        ALI_ACK_P6_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ALI_ACK_P6_R {
