#[doc = "Register `SPI2_ACK` reader"]
pub struct R(crate::R<SPI2_ACK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPI2_ACK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPI2_ACK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPI2_ACK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPI2_ACK` writer"]
pub struct W(crate::W<SPI2_ACK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI2_ACK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI2_ACK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI2_ACK_SPEC>) -> Self {
        W(writer)
    }
}
...
impl R {
    ...
    pub fn mapping_ack(&self) -> MAPPING_ACK_R {
        MAPPING_ACK_R::new((self.bits & 0x01) != 0)
    }
...
pub struct SPI2_ACK_SPEC;
impl crate::RegisterSpec for SPI2_ACK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi2_ack::R](R) reader structure"]
impl crate::Readable for SPI2_ACK_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi2_ack::W](W) writer structure"]
impl crate::Writable for SPI2_ACK_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPI2_ACK to value 0"]
impl crate::Resettable for SPI2_ACK_SPEC {
    #[inline(always)]
