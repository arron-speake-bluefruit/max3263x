...
pub type SDIO_SAMPLE_POINT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `sdio_sample_point` writer - SDIO Sample Point"]
pub type SDIO_SAMPLE_POINT_W<'a> = crate::FieldWriter<'a, u32, MSTR_CFG_SPEC, u8, u8, 4, 20>;
impl R {
