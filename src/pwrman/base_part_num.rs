...
pub struct BASE_PART_NUMBER_R(crate::FieldReader<u16, u16>);
impl BASE_PART_NUMBER_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        BASE_PART_NUMBER_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BASE_PART_NUMBER_R {
