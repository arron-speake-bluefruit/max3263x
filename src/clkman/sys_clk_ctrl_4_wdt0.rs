...
pub struct WATCHDOG0_CLK_SCALE_R(crate::FieldReader<u8, u8>);
impl WATCHDOG0_CLK_SCALE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        WATCHDOG0_CLK_SCALE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WATCHDOG0_CLK_SCALE_R {
...
pub struct WATCHDOG0_CLK_SCALE_W<'a> {
    w: &'a mut W,
}
impl<'a> WATCHDOG0_CLK_SCALE_W<'a> {
