...
pub struct BYTE4_R(crate::FieldReader<u8>);
impl BYTE4_R {
    #[inline(always)]
...
pub struct BYTE5_R(crate::FieldReader<u8>);
impl BYTE5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct BYTE6_R(crate::FieldReader<u8>);
impl BYTE6_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct BYTE7_R(crate::FieldReader<u8>);
impl BYTE7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
